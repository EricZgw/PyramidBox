...
class TrainModel(PrepareData):
    ...
    def __start_training(self):
        ...
        gclasses_head, localizations_head, gscores_head, gclasses_body, localizations_body, gscores_body = self.get_wider_face_train_data()

        # get model outputs
        localisations, logits, end_points = g_ssd_model.get_model(image, weight_decay=self.weight_decay,
                                                                  is_training=True)
